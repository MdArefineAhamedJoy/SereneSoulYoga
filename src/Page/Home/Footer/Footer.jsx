  ...
  return (
    <footer className="mt-20 bg-black text-white">
      <div className="md:flex text-base-content w-full ">
        <div className="  md:w-[30%]  md:pt-20 w-full p-5 md:text-right flex flex-col h-96 text-white ">
          <div className=" flex items-center flex-col gap-2">
            <span className="font-extrabold  py-2  pb-2 font-3xl">
              WORK HOURS
            </span>
            <div className="  py-2   ">
              <p>Monday - Thursday</p>
        ...
        <div className="  md:w-[40%] w-full md:pt-16   mx-auto p-5  ">
          ...
          <p>
            ...
            provide various services to the nature of the clients. Wish how you
            would like to spend the time here we can talk and come to a
            conclusion. Phasellus et nisl tellus. Etiam facilisis eu nisi
        ...
        <div className="md:w-[30%] text-left w-full md:pt-20 p-5   flex flex-col h-96  text-white ">
          <span className="font-bold  text-left text-lg mb-2 pb-2     ">
            CONTACT US
          </span>
          <div className="py-2">
          ...
          <div className="py-2">
            <p className="flex gap-2 items-center">
              {" "}
              <FaSearchLocation></FaSearchLocation> 625 @ David Blake Road,{" "}
            </p>
